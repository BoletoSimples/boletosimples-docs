...
| Recurso                  | Descrição
| ------------------------ | ------------------------
| [GET /api/v1/transactions/new](#novo-saque)           | Novo saque
| [POST /api/v1/transactions](#solicitar-saque)         | Solicitar saque
...
| [GET /api/v1/transactions/withdrawals](#listar-saques)| Listar saques
...
-X GET 'https://sandbox.boletosimples.com.br/api/v1/transactions/new'
</pre>
...
-H 'Content-Type: application/json' \
-H 'User-Agent: MyApp (myapp@example.com)' \
-X POST 'https://sandbox.boletosimples.com.br/api/v1/transactions'
</pre>
...
Status: 201 Created
Location: https://sandbox.boletosimples.com.br/api/v1/transactions/1
Content-Type: application/json; charset=utf-8
...
...
-H 'Content-Type: application/json' \
-H 'User-Agent: MyApp (myapp@example.com)' \
-X GET "https://sandbox.boletosimples.com.br/api/v1/transactions/withdrawals?page=1&per_page=2"
</pre>
...
Date: Fri, 17 Oct 2014 19:46:16 GMT
Status: 200 OK
Link: <https://sandbox.boletosimples.com.br/api/v1/transactions/withdrawals?page=2&per_page=2>; rel="last", <https://sandbox.boletosimples.com.br/api/v1/transactions/withdrawals?page=2&per_page=2>; rel="next"
Total: 4
Content-Type: application/json; charset=utf-8
...
...
[
  ...
  },
  {
    ...
    "amount": -5.0,
    "created_at": "2015-02-10",
    "description": "Taxa do saque no valor de R$ 9,01",
    "kind": "withdrawal_fee",
    "processed_at": "2015-02-19",
    "sent_at": null,
    "status": "processed",
