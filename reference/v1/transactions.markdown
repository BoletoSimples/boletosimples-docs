...
-X GET 'https://api-sandbox.kobana.com.br/v1/transactions/1'
</pre>
...
-H 'Content-Type: application/json' \
-H 'User-Agent: MyApp (myapp@example.com)' \
-X GET "https://api-sandbox.kobana.com.br/v1/transactions?page=1&per_page=2"
</pre>
...
Date: Fri, 17 Oct 2014 19:46:16 GMT
Status: 200 OK
Link: <https://api-sandbox.kobana.com.br/v1/transactions?page=2&per_page=2>; rel="last", <https://api-sandbox.kobana.com.br/v1/transactions?page=2&per_page=2>; rel="next"
Total: 4
Content-Type: application/json; charset=utf-8
...
