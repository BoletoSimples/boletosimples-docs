...
Para poder usar a autenticação via **Chave secreta da API**, você precisa pegar o sua `Chave da API` na [página de API (Sandbox)](https://sandbox.boletosimples.com.br/conta/api) da sua conta.
